  ...
  return (
    <div className="w-full">
      <input
        ref={ref}
        className={cn(
            'flex h-11 w-full rounded-[14px] border px-4 py-2 text-base caret-cyan-300 backdrop-blur-xl focus:border-transparent focus:outline-none focus:ring-2 disabled:cursor-not-allowed disabled:opacity-50 sm:h-10 sm:text-sm',
            resolvedTheme === 'dark'
