...
public class ResendPasswordResetEmailSender implements PasswordResetEmailSender {
    ...
    public ResendPasswordResetEmailSender(
            @Value("${resend-email.api-key:${app.resend-email.api-key:}}") String apiKey,
            @Value("${resend-email.from-address:${app.resend-email.from-address:onboarding@resend.dev}}") String fromAddress
    ) {
